  ...
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        orange:
          "bg-primary-orange text-neutral-50 hover:bg-primary-blue/90 dark:bg-primary-blue dark:text-neutral-50 dark:hover:bg-primary-blue/90",
        violet:
          "bg-violet-700 text-neutral-50 hover:bg-primary-blue/90 dark:bg-primary-blue dark:text-neutral-50 dark:hover:bg-primary-blue/90",
        success:
          "bg-green-700 text-neutral-50 hover:bg-primary-blue/90 dark:bg-primary-blue dark:text-neutral-50 dark:hover:bg-primary-blue/90",
      },
    },
    defaultVariants: {
      variant: "default",
